...
<body class="bg-gray-100">
  <div class="flex min-h-screen">
    <nav class="bg-blue shadow fixed w-full z-10">
      <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <a href="#" class="text-xl font-bold text-blue-600">Jelajah Bandung</a>
        <ul class="flex space-x-6">
          <li><a href="{{ route('landing.home') }}" class="hover:text-blue-600">Home</a></li>
          <li><a href="#paket-wisata" class="hover:text-blue-600">Paket Wisata</a></li>
          <li><a href="#kontak" class="hover:text-blue-600">Kontak</a></li>
          <li><a href="#alasan" class="hover:text-blue-600">Tentang Kami</a></li>
        </ul>
      </div>
    </nav>
