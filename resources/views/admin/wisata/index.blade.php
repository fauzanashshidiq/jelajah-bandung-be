...
<a href="{{ route('wisata.create', ['id_paket' => $paket->id_paket]) }}" class="inline-block mb-4 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">+ Tambah Wisata</a>
...
<table  class="w-full border-collapse border border-gray-300">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2 text-center">{{ $wisata->nama_wisata }}</td>
            <td class="border border-gray-300 px-4 py-2 text-center">{{ $wisata->deskripsi_wisata }}</td>
            ...
            <td class="border border-gray-300 px-4 py-2 text-center space-x-2">
                <a href="{{ route('wisata.edit', $wisata->id_wisata) }}" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">Edit</a>
                
                <form action="{{ route('wisata.destroy', $wisata->id_wisata) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
